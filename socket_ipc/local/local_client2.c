...
#define CLIENT_MODULE_ADDR		   LOCAL_CLIENT_2_ADDR
#define LOCAL2_DELAY_FOR_DEBUG_US  (1000*1000)
...
int ClientSendMsg(int s32TargModuleAddr)
{
	...
	l_stMsgSend.u16SensorSpeed= 0x33;
	l_stMsgSend.u16SpeedX10   = 0x44;
...
int main(int argc,char *argv[])
{
	...
	l_as32SendAddr[0] = LOCAL_CLIENT_1_ADDR;
