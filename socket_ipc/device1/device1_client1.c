...
#define CLIENT_MODULE_ADDR		   DEV1_CLIENT_1_ADDR
...
int ClientSendMsg(int s32TargModuleAddr)
{
	...
	l_stMsgSend.u16Altitude   = 0x11;
	l_stMsgSend.u16Direct     = 0x11;
	l_stMsgSend.u16SensorSpeed= 0x11;
	l_stMsgSend.u16SpeedX10   = 0x22;
	l_stMsgSend.u32Alarm      = 0x33;
	l_stMsgSend.u32Latitude   = 0x44;
	l_stMsgSend.u32Longtitude = 0x55;
	l_stMsgSend.u32Status     = 0x66;
	l_stMsgSend.u8CarCor	  = 0x77;
...
int main(int argc,char *argv[])
{
	...
	l_as32SendAddr[1] = LOCAL_CLIENT_1_ADDR,
